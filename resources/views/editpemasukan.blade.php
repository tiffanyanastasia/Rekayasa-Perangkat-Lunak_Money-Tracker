            ...
            <div class="card-body">
                <div class="tab-content p-4">
                    <div id="budgeteer" class="active tab-pane fade in show">
                        <form class="expenseForm" action="/pemasukan/{{ $pemasukan->id }}/edit" method="POST" onsubmit="addExpense(); return false;">
                            @csrf
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" id="nominal" name="jumlah" placeholder="Jumlah" value="{{ $pemasukan->jumlah }}">
                            </div>
